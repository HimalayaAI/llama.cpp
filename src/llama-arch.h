...
enum llm_tensor {
    ...
    LLM_TENSOR_NANOCHAT_RESID_LAMBDAS,
    LLM_TENSOR_NANOCHAT_X0_LAMBDAS,
    LLM_TENSOR_NANOCHAT_SMEAR_GATE,
    LLM_TENSOR_NANOCHAT_SMEAR_LAMBDA,
    LLM_TENSOR_NANOCHAT_BACKOUT_LAMBDA,
    ...
    LLM_TENSOR_NANOCHAT_VALUE_EMBD,
    LLM_TENSOR_NANOCHAT_VE_GATE,
