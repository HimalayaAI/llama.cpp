...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_NANOCHAT_RESID_LAMBDAS,                 "nanochat_resid_lambdas" },
    { LLM_TENSOR_NANOCHAT_X0_LAMBDAS,                    "nanochat_x0_lambdas" },
    { LLM_TENSOR_NANOCHAT_SMEAR_GATE,                    "nanochat_smear_gate" },
    { LLM_TENSOR_NANOCHAT_SMEAR_LAMBDA,                  "nanochat_smear_lambda" },
    { LLM_TENSOR_NANOCHAT_BACKOUT_LAMBDA,                "nanochat_backout_lambda" },
    ...
    { LLM_TENSOR_NANOCHAT_VALUE_EMBD,                    "blk.%d.nanochat_value_embd" },
    { LLM_TENSOR_NANOCHAT_VE_GATE,                       "blk.%d.nanochat_ve_gate" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_NANOCHAT_RESID_LAMBDAS,     {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_NANOCHAT_X0_LAMBDAS,        {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_NANOCHAT_SMEAR_GATE,        {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NANOCHAT_SMEAR_LAMBDA,      {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_NANOCHAT_BACKOUT_LAMBDA,    {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    ...
    {LLM_TENSOR_NANOCHAT_VALUE_EMBD,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_NANOCHAT_VE_GATE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
